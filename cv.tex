...
\MySlogan{\vspace{-0.2in}\begin{flushright}Biodiversity Economics\\German Centre for Integrative Biodiversity Research (iDiv)   Halle-Jena-Leipzig \\
\href{mailto:julian.sagebiel@idiv.de}{julian.sagebiel@idiv.de}\\
\href{https://www.idiv.de/en/profile/1665.html}{idiv.de}
\end{flushright}}

\sepspace
 \NewPart{Overview}{}
 I am a Postdoc at the ``Biodiversity Economics'' group at the German Centre for Integrative Biodiversity Research (iDiv) Halle-Jena-Leipzig with a focus in environmental valuation. My key expertise lies in discrete choice modelling and stated preferences methods. I currently work in the Project ``ValuGaps''. 
%%% Personal details
%%% ------------------------------------------------------------
...
\EducationEntry{Postdoc}{2022-}{German Centre for Integrative Biodiversity Research (iDiv) Halle-Jena-Leipzig}
{\begin{itemize}
\item{Valuation of Natural Capital and Biodiversity}
\item{Non-Market Valuation Methods}
\item{Survey Design}
\end{itemize}}
\sepspace
...
% \item Prof. Jette Bredahl Jacobsen (Professor and deputy head of department Food and Resource Economics, University of Copenhagen, Rolighedsvej 23, 1958 Frb. C, \href{mailto:jbj@ifro.ku.dk}{jbj@ifro.ku.dk}, +45 35 33 17 46) 
% \item Dr. Klaus Glenk (Team Leader, Sustainable Ecosystems at  Scotland's Rural College, SRUC, West Mains Road, Kings Buildings, Peter Wilson Building, EH9 3JG Edinburgh,  United Kingdom, \href{mailto:klaus.glenk@sruc.ac.uk}{klaus.glenk@sruc.ac.uk})
% \item Prof. Mikolaj Czajkowski (Professor in the Faculty of Economic Sciences, University of Warsaw, Długa 44/50 
...
\begin{etaremune}
\item \bibentry{marder2023}
\item \bibentry{rommel2022publicgood}
\item \bibentry{rommel2022farmers}
\item \bibentry{welling2022information}
\item \bibentry{rogers2022adolescent}
